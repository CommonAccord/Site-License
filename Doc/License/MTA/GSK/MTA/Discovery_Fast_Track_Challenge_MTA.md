Source=<a href="http://www.openinnovation.gsk.com/downloads/Discovery_Fast_Track_Challenge_MTA.pdf">GSK Open Innovation PDF</a>

Model.Root={DocBody}

DocBody=<center><b>{Agt.Ti}</b></center>{Agt.Intro}{Agt.Secs}{Agt.Sign}{Agt.Attach}
...
Def.Sec=<b>{Def.Ti}</b><ul type="none"><li>{Def.Affiliate}</li><li>{Def.Confidential_Information}</li><li>{Def.Confirmed_Hit}</li><li>{Def.DPAc_Agreement}</li><li>{Def.P1_Results}</li><li>{Def.P1_Transfer_Contract}</li><li>{Def.P2's_Investigator}</li><li>{Def.P2_Results}</li><li>{Def.Material}</li><li>{Def.Material_Transfer_Record}</li><li>{Def.Research}</li><li>{Def.Research_Plan}</li></ul>
Submit.Sec=<b>{Submit.Ti}</b><ol><li>{Submit.PerPlan.Sec}</li><li>{Submit.Limit.Sec}</li><li>{Submit.Hits.Sec}</li><li>{Submit.P1Report.Sec}</li><li>{Submit.P1Free.Sec}</li></ol>

Outcome.Sec=<b>{Outcome.Ti}</b><br> {Outcome.Intro}<ol><li>{Outcome.1.Sec}</li><li>{Outcome.2.Sec}</li><li>{Outcome.3.Sec}</li><li>{Outcome.4.Sec}</li></ol>

IP.Sec=<b>{IP.Ti}</b><ol ><li>{IP.Prior.Sec}</li><li>{IP.P2.Sec}</li><li>{IP.P1.Sec}</li><li>{IP.Other.Sec}</li><li>{IP.Disclaim.Sec}</li></ol>

Conf.Sec=<b>{Conf.Ti}</b><ol><li>{Conf.Def.Sec}</li><li>{Conf.Except.sec}</li><li>{Conf.Care.Sec}</li><li>{Conf.Except.Compelled.Sec}</li><li>{Conf.Publication.Sec}</li></ol>

Rep.Sec=<b>{Rep.Ti}</b><ol><li>{Rep.P2.Disclaim.Sec}</li><li>{Rep.P1.Handling.Sec}</li><li>{Rep.P2.LawfullyObtained.Sec}</li><li>{Rep.P1.Disclaim.Sec}</li></ol>

Misc.Sec=<b>{Misc.Ti}</b><ol><li>{Misc.Expire.Sec}</li><li>{Misc.Return.Sec}</li><li>{Misc.Survive.Sec}</li><li>{Misc.Notice.Sec}</li><li>{Misc.Assign.Sec}</li><li>{Misc.Entire.Sec}</li><li>{Misc.Amend.Sec}</li><li>{Misc.Waiver.Sec}</li><li>{Misc.Publicity.Sec}</li><li>{Misc.Law.Sec}</li><li>{Misc.Counterpart.Sec}</li></ol>

Agt.Ti=MATERIAL TRANSFER AGREEMENT
...
Intro.Recital=<center>{Recital.Ti}</center>{Recital.List}
Recital.Ti=W I T N E S S E T H:
...
Outcome.1.Sec=<b>{Outcome.1.Ti}</b><br> {Outcome.1.Intro}:<ol type="a"><li>{Outcome.1.Negotiate}</li><li>{Outcome.1.UseOfData}</li><li>{Outcome.1.FailureOfNegotiation}</li></ol>
...
Rep.Ti=Representations and Warranties
...
Research Plan=<font color="green">Research Plan</font>
