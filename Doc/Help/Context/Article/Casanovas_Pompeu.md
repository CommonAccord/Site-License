...
Link=<a href="http://buscalegis.ufsc.br/revistas/index.php/observatoriodoegov/article/view/34399">

Model.Root=<center>{Ti}<br>{Author}</center><br><br>{Summary}<br><br><a href="{Link}">{Ti}</a>
